    ...
    public class AccessManager
    {
        ...
        private List<Tuple<string, UserAccessLevelEnum>> GetAccessPerPageList()
        {
            var list = new List<Tuple<string, UserAccessLevelEnum>>
            {
                ...
                new Tuple<string, UserAccessLevelEnum>(Constants.ExchangeRatePage, UserAccessLevelEnum.Intermedio),
                ...
                new Tuple<string, UserAccessLevelEnum>(Constants.ReturnsPage, UserAccessLevelEnum.Intermedio),
